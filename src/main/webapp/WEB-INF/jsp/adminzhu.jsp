...
<div id="geren">
    <div id="app">
                ...
                <div class="modal-content">
                    ...
                    <form>
                        ...
                        <div class="input-group" >
                            <input type="text" class="form-control" placeholder="新闻标题" aria-describedby="basic-addon1"  style="width:500px;height:30px; margin-left: 3.75rem;">
                        </div>
                        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;新闻内容</p>
                        <div class="input-group" >
                            <textarea name="a" style="width:500px;height:500px;margin-left: 3.75rem;">这里写内容</textarea>
                        </div>
        ...
        <p>姓名:</p>
        <input  type="button" class="btn btn-primary" value="发布新闻"data-toggle="modal" data-target="#myModal" @click="#myModal"/>
    </div>
</div>
<div id="back-to-top">
