    ...
    <div class="top-bar hidden-sm hidden-xs">
        <div class="row">
            <div class="col-sm-9 col-xs-12">
                ...
                <!-- 官方电子邮箱 -->
                <span class="top-info"><i class="fa fa-envelope-o"></i></span>xxx@xxx.com
                <!-- 地址 -->
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="about.html">专家预约</a></li>
            ...
            <div class="acb">
                <div class="col-md-6 col-sm-12 col-xs-12 about-col">
                    <div class="box wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".5s">
                        <h4 class="main-heading1">专家名称</h4>
                        <p>专家简介</p>
                        <div class="row">
                            <div class="col-sm-6 col-xs-12">
                                <ul class="list-unstyled list-style-3">
                                    <li><a href="#">上班时间:</a></li>
                                    <li><a href="#">空闲时间:</a></li>
                                    <a href="appointment.html" class="btn btn-black text-uppercase pull-right">预约</a>
                                </ul>
                            </div>
                            <div class="col-sm-6 col-xs-12">
                                <ul class="list-unstyled list-style-3"></ul>
                            </div>
                        </div>
                    </div>
                </div>
